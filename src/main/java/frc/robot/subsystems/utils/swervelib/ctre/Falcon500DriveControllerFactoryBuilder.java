package frc.robot.subsystems.utils.swervelib.ctre;
...
import frc.robot.subsystems.utils.swervelib.DriveController;
import frc.robot.subsystems.utils.swervelib.DriveControllerFactory;
import frc.robot.subsystems.utils.swervelib.ModuleConfiguration;
...
public final class Falcon500DriveControllerFactoryBuilder {
    ...
    private class FactoryImplementation implements DriveControllerFactory<ControllerImplementation, Integer> {
        ...
        public ControllerImplementation create(Integer driveConfiguration, ModuleConfiguration moduleConfiguration) {
            ...
            TalonFX motor = new TalonFX(driveConfiguration, "Swerve CANivore");
    ...
    public class ControllerImplementation implements DriveController {
