...
import frc.robot.subsystems.utils.swervelib.AbsoluteEncoder;
import frc.robot.subsystems.utils.swervelib.AbsoluteEncoderFactory;
...
public class CanCoderFactoryBuilder {
    ...
    public AbsoluteEncoderFactory<CanCoderAbsoluteConfiguration> build() {
        return configuration -> {
            ...
            CANCoder encoder = new CANCoder(configuration.getId(), "Swerve CANivore");
